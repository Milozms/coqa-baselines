...
def get_args():
    ...
    group.add_argument('--doc_mark_embed', type=str2bool, default=True)
    ...
    group.add_argument('--predict_span', type=str2bool, default=True)
    ...
    group.add_argument('--reduce_lr', type=str2bool, default=False, help='Reduce Lr. (for SGD)')
    group.add_argument('--reduce_lr_factor', type=float, default=0.5, help='Reduce Lr. (for SGD)')
    group.add_argument('--reduce_lr_patience', type=int, default=5, help='Reduce Lr. (for SGD)')
